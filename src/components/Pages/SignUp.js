...
export default connect(
    ...
    validationSchema: Yup.object().shape({
         name: Yup.string().required('You need to give us your name'),
         email: Yup.string().email('Email is invalid').required('You need to login with email address'),
         password: Yup.string().min(8,'Password needs to be atleast 8 characters long').required('You need to enter your password'),
