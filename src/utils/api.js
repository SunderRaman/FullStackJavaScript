...
const API = {
    ...
    getSitePosts : (skip,success) => {
        ...
        .then(res => {
            console.log ("Get Site Posts in API.js is ", res);
            success(res);
        });
    },
    addPost : (post, token,success) => {
        console.log("We are adding", post, token)
    ...
    updatePost : (post, token,success) => {
        console.log("We are updating", post, token)
    ...
    getSinglePost : (id, token,success) => {
        console.log("We are getting the post with id as ", id)
